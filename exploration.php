...
<body>
    ...
    <a href="home.html">
        <img src="./image/Capture d'écran 2024-10-26 081223.png" alt="Logo">
    </a>
    <div id="contenu">
        <div id="texte">
            <p>Nuage de points</p>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $dataB = [];
            $dataM = [];
            $query = "SELECT `$table_name`.`$varX` AS variable_x, diagnostic.`libelle_diagnostic` AS type_diagnostic 
                      FROM diagnostic, `$table_name` 
                      WHERE `$table_name`.`code_diagnostic` = diagnostic.`code_diagnostic`;";
